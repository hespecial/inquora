create database inquora_article;
use inquora_article;
...
-- goctl model mysql datasource --dir ./internal/model --table article --cache true --url "root:jiaomu2014@tcp(127.0.0.1:3306)/inquora_article"