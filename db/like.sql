...
CREATE TABLE `like_record` (
    ...
    `obj_id` bigint(20) NOT NULL DEFAULT '0' COMMENT '点赞对象id',
...
-- goctl model mysql datasource --dir ./internal/model --table like_record --cache true --url "root:jiaomu2014@tcp(127.0.0.1:3306)/inquora_like"
-- goctl model mysql datasource --dir ./internal/model --table like_count --cache true --url "root:jiaomu2014@tcp(127.0.0.1:3306)/inquora_like"
